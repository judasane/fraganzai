...
const PerfumeCreatorModal: React.FC<PerfumeCreatorModalProps> = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-2">Describe yourself, a memory, or a feeling, and our AI will craft your unique fragrance profile.</p>
        </div>
        ...
        {!profile ? (
          ...
          <div className="text-left animate-in fade-in space-y-6">
            ...
            <Button variant="secondary" size="md" className="w-full" onClick={() => setProfile(null)}>
              Create Another
            </Button>
          </div>
        )}
